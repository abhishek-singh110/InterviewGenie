...
export function JDUploadForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (jdText && file) {
      setError("Please provide either a job description OR a file, not both.")
      return
    }
  ...
  //     const genRes = await fetch(`http://127.0.0.1:8000/extract-and-generate/${user_id}`, {
  //       method: "POST",
  //       body: formData, // ✅ No headers, fetch auto-sets multipart boundary
  //     })
  ...
  return (
    <Card className="w-full max-w-2xl">
      <CardHeader>
        ...
        <CardDescription>
          Paste a JD or upload a file and we’ll generate tailored interview questions.
        </CardDescription>
      </CardHeader>
      <CardContent>
